...
## 📌 Project Overview
This project delivers an end-to-end analytics solution using Python, SQL, and Power BI to analyse Zepto-style quick-commerce retail data. The goal is to uncover pricing inefficiencies, margin leakage, discount behaviour, stock risks, and replenishment gaps to support data-driven operational and pricing decisions. The project demonstrates complete data cleaning, validation, feature engineering, and dashboard development.
## 📂 Dataset 
Source: Kaggle
